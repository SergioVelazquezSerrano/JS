...
var Usuario = /*#__PURE__*/function () {
  ...
  _createClass(Usuario, [{
    ...
    key: "info",
    value: function info() {
      return "<br>Nombre: ".concat(this.nombre, " tiene ").concat(this.edad, " a\xF1os");
    }
  }]);
...
var Estudiante = /*#__PURE__*/function (_Usuario) {
  ...
  _createClass(Estudiante, [{
    key: "info",
    value: function info() {
      return "<br>Nombre: ".concat(this.nombre, " tiene ").concat(this.edad, " a\xF1os y estudia ").concat(this.grado);
    }
  }]);
